...
<main>
  <div class=\"position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary\">
    <div class=\"col-md-6 p-lg-5 mx-auto my-4\">
      <img src=\"../images/imagen.jpeg\" alt=\"Iván Bermejo Hidalgo\" class=\"rounded-circle mb-3\" style=\"width: 200px; height: 200px; object-fit: cover;\">      
...
<div class=\"position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary\" id=\"experiencia\">
  <br>
  <h2 class=\"display-6 fw-bold\" >EXPERIENCIA</h2>
  <div class=\"d-md-flex flex-md-equal w-100 my-md-3 ps-md-3\">
    <div class=\"text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden\">
      <div class=\"my-3 py-3\">
        <h2 class=\"display-5\"><b>Técnico informático</b></h2>
        <h3 class=\"lead\">Octubre 2024 - Actualidad</h3>
      </div>
      <div class=\"bg-body-tertiary shadow-sm mx-auto\" style=\"width: 80%; height: 200px; border-radius: 21px 21px 0 0; overflow: hidden;\">
        <img src=\"../images/seag.png\" alt=\"Experiencia SEAG\" style=\"width: 100%; height: 100%; object-fit: contain;\">      
      </div>    
    </div>
    ...
    <div class=\"text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden\">
      ...
      <div class=\"bg-dark shadow-sm mx-auto\" style=\"width: 80%; height: 250px; border-radius: 21px 21px 0 0; overflow: hidden;\">
        <img src=\"../images/lesne.png\" alt=\"Experiencia Les Neus\" style=\"width: 80%; height: 80%; object-fit: contain;\">      
      </div>
    </div>
